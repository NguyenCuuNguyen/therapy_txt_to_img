...
log_file = os.path.join(log_dir, "sdxl_chunks_unscaled_norefiner.log") 
...
def generate_images_for_csv_rows( 
    ...
    yaml_path, 
    id_list_path, 
    output_dir="/home/iris/Documents/deep_learning/generated_images/sdxl_unscaled_chunks", 
    temp_dir="/home/iris/Documents/deep_learning/generated_images/sdxl_unscaled_chunks_temp", 
    chunk_size=1, 
): 
